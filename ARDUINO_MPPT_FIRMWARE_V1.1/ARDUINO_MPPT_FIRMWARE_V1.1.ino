...
telemCounterReset       = 1,           //  USER PARAMETER - Reset Telem Data Every (0 = Never, 1 = Day, 2 = Week, 3 = Month, 4 = Year) 
...
float 
voltageBatteryMax       = 14.6,     //   USER PARAMETER - Maximum Battery Charging Voltage (Output V)
voltageBatteryMin       = 9,     //   USER PARAMETER - Minimum Battery Charging Voltage (Output V)
currentCharging         = 10.0000,     //   USER PARAMETER - Maximum Charging Current (A - Output)
...
float
vOutSystemMax           = 35,    //  CALIB PARAMETER - 
cOutSystemMax           = 6,    //  CALIB PARAMETER - 
ntcResistance           = 9000.00,   //  CALIB PARAMETER - NTC temp sensor's resistance. Change to 10000.00 if you are using a 10k NTC
voltageDropout          = 0.2000,     //  CALIB PARAMETER - Buck regulator's dropout voltage (DOV is present due to Max Duty Cycle Limit)
voltageBatteryThresh    = 1.5000,     //  CALIB PARAMETER - Power cuts-off when this voltage is reached (Output V)
currentInAbsolute       = 10,    //  CALIB PARAMETER - Maximum Input Current The System Can Handle (A - Input)
currentOutAbsolute      = 6,    //  CALIB PARAMETER - Maximum Output Current The System Can Handle (A - Input)
...
SDL_Arduino_INA3221 ina3221(0x41, 0.01f);
...
//0000000000000000  0 111 010 100 100 111
